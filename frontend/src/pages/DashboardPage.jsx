...
const DashboardPage = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-[#0d0d1a] text-white overflow-hidden">
            ...
            {/* Navbar */}
            <nav className="flex items-center justify-between px-5 h-13 bg-[#16213e] border-b border-[#0f3460] flex-shrink-0 z-10" style={{ height: '52px' }}>
                ...
                <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#e94560] flex items-center justify-center text-xs font-medium cursor-pointer">
